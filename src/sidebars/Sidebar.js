...
// getting side bar images and businessName from redux
    const { businessName,displayPicture } = props.sidebarValue
                ...
                <ul className=" nav-menu-items" >
                    ...
                    <li className=" side-box d-none  d-lg-block ">
                        ...
                        <div className="sidebar-image d-flex  flex-column justify-content-center align-items-center my-4">
                            <input type="image" onError="/images/arimoro.jpeg"  placeholder="/images/arimoro.jpeg" style={{ width: "150px", height: "150px" }} alt="profile_image" src={displayPicture}  className=" rounded-circle imageDisplay align-self-center" id="imageDisplay" />
...
const MapStateToProps = (state) => {
    return {
        sidebarValue: state.userReducer.editUSer
    }
}
